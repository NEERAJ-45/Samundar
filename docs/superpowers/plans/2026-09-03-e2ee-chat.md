...
### Task 3: IndexedDB Storage — `src/lib/db.ts`
...
- [ ] **Step 1: Create db.ts with IndexedDB wrapper**
...
import { saveIdentity, getIdentity } from '@/lib/db';
...
import { useState } from 'react';
import { addContact, type Contact } from '@/lib/db';
import { deriveSafetyCode } from '@/lib/crypto';
import { getIdentity } from '@/lib/db';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
...
import { getIdentity, getMessages, addMessage, updateMessageStatus, getContact, type StoredMessage } from '@/lib/db';
...
| 3 | `lib/db.ts` — IndexedDB CRUD | Task 2 |
