          ...
          <div key={entry.id}>
            ...
            >
              ...
              <button
                onClick={() =>
                  update((currentEntries) =>
                    duplicateEntry(currentEntries, entry.id),
                  )
                }
                className="p-0.5 rounded opacity-0 group-hover:opacity-100 hover:bg-zinc-800 text-zinc-600 hover:text-zinc-300 transition-all shrink-0"
                title="Duplicate"
              >
